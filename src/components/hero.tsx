...
const HeroText = (props: PropsWithLocalizedCopy & { className?: string }) => (
  ...
  >
    <div className="w-full max-w-[calc(100%-40px)] rounded-tl-lg rounded-bl-lg border border-white/20 bg-black/5 px-4 py-2 backdrop-blur-sm sm:max-w-[calc(100%-80px)] sm:px-8 sm:py-4 right-0 ml-auto">
