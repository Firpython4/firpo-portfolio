...
(
    <div className="w-full flex flex-col md:flex-row justify-center md:gap-[215px]">
        <div
            className={`w-[434px] h-[535px] text-black text-[17px] not-italic font-semibold leading-[27px] pt-[118px] font-inter`}>Tenho
