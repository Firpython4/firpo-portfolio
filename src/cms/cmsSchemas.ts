import { z } from "zod";
import { typefs } from "@firpy/type-fs";
...
const orderFile = () => typefs.textFile().withName("order").optional();
...
export const cms = typefs.object({
  public: typefs
    .object({ collections: typefs.array(collection).withName("collections") })
    .withName("public"),
  order: orderFile(),
});
